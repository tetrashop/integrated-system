...
const PORT = 3003; // تغییر پورت به 3003
...
const server = http.createServer((req, res) => {
  ...
  res.end(`
    ...
    <head>
        <meta charset="UTF-8">
        <title>پنل تبدیل 3D - پورت ${PORT}</title>
        <style>
            body { 
